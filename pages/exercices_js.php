...
$CardAddition->addElement('<input type="reset" class="button secondary" id="btnResetAdd" value="Reset" >');
...
$CardMinToSec->addElement('<input type="reset" class="button secondary" id="reset_min_to_sec" value="Reset" >');
